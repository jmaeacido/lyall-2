...
const services = [
  ...
  { n:"04", title:"Stump Grinding & Land Clearing", text:"A clean, level finish that leaves your yard ready for the next thing you want to grow or build.", image:photos.chainsaw, alt:"Controlled chainsaw work on site" },
];
...
export default function Home(){
  ...
  return <main>
    <section id="top" className="hero">
      <nav className="nav wrap"><a href="#top" className="logo"><span>✳</span><b>Lyall Property Care</b><small>LLC</small></a><button className="menuBtn" onClick={()=>setMenu(!menu)} aria-label="Toggle menu">{menu?"Close":"Menu"}</button><div className={menu?"navlinks open":"navlinks"}><a href="#about">About</a><a href="#services">Services</a><a href="#process">Approach</a><a href="#quote">Contact</a></div><a className="navCta" href="#quote">Free estimate ↗</a></nav>
    ...
    <footer className="footer wrap"><a href="#top" className="logo"><span>✳</span><b>Lyall Property Care</b><small>LLC</small></a><p>Professional, fully insured tree care<br/>in the Hudson Valley.</p><div><a href="#about">About</a><a href="#services">Services</a><a href="#quote">Contact</a></div><small>© 2026 Lyall Property Care LLC · Field photography by Leon Steel</small></footer>
  </main>
}
